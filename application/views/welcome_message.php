      ...
      <div class="aa-top-slider">
        ...
        <div class="aa-top-slider-single">
          ...
          <div class="aa-top-slider-content">
            ...
            <h2 class="aa-top-slider-title">บ้านใกล้ห้าง ใกล้ทางด่วน</h2>
            <p class="aa-top-slider-location"><i class="fa fa-map-marker"></i>ถนนราชพฤกษ์ ซอยบางกรวย-จงถนอม, บางกรวย, นนทบุรี</p>
            <span class="aa-top-slider-off">30% OFF</span>
            <p class="aa-top-slider-price">฿4,590,000</p>
